    ...
    <>
      ...
      <Box mx={"auto"} pt="4" px={{ base: 3, sm: 2, md: 8 }}>
        <HeaderSection title={`Top 50 Box Office`}>
          {`
In this section, you will see 50 best-selling movies in each category. The categories are:

* **The Worldwide Box** contains information on total global revenue generated by each film.

  

* **The Domestic Box** provides details about a movie's domestic (U.S.) earnings.

  

* **The International Box** shows foreign revenues earned by films outside of their home country for all countries around the world combined into one file.
          `}
        </HeaderSection>
